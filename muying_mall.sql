...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '账户交易记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 152 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '购物车表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 266 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_product`  (
  ...
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE,
  INDEX `idx_product_id`(`product_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 106 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单商品表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `payment`  (
  ...
  INDEX `idx_version`(`version` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 293 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '支付表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `points_history`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 150 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '积分历史记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `product` VALUES (59, 6, 4, '孕妇维生素', 'BY049', 'goods59.jpg', '全面营养配方，补充叶酸和铁质，适合孕期全程使用。', 189.90, 239.90, 246, 200, 180, 4.8, 160, '上架', 1, 0, 1, '2025-05-31 14:00:00', '2025-05-11 13:25:00', 1);
...
INSERT INTO `product` VALUES (98, 1, 2, '美素佳儿金装较大婴儿配方奶粉2段', 'BY098', 'goods98.jpg', '荷兰原装进口，含益生元，支持宝宝肠道健康。', 358.00, 428.00, 190, 147, 125, 4.8, 115, '上架', 1, 0, 1, '2025-06-01 13:05:00', '2025-06-11 17:40:00', 1);
...
CREATE TABLE `user`  (
  ...
  INDEX `idx_version`(`version` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 60 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户账户表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_account` VALUES (5, 8, 18844.00, 0.00, 0, 1, NULL, 1, NULL, NULL, '2025-06-06 17:48:02', '2025-07-16 18:56:11');
...
INSERT INTO `user_points` VALUES (5, 8, 33341, '钻石会员', '2025-02-28 11:20:15', '2025-07-11 13:17:36');
