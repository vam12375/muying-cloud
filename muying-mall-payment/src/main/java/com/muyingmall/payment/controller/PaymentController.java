package com.muyingmall.payment.controller;
...
import com.muyingmall.payment.config.AlipayConfig;
...
import com.muyingmall.payment.mapper.OrderMapper;
import com.muyingmall.payment.service.OrderService;
import com.muyingmall.payment.service.PaymentService;
import com.muyingmall.payment.service.UserService;
import com.muyingmall.payment.service.UserAccountService;
import com.muyingmall.payment.service.CacheRefreshService;
import com.muyingmall.payment.service.OrderNotificationService;
...
public class PaymentController {
    ...
    public Result<Map<String, Object>> createWechatSandboxPayment(@PathVariable("orderId") Integer orderId) {
        ...
        try {
            ...
            return Result.success("微信沙箱支付创建并模拟成功", result);
    ...
    public Result<Map<String, Object>> createWalletPayment(@PathVariable("orderId") Integer orderId,
        ...
        try {
            ...
            return Result.success("钱包支付成功", result);
    ...
    public Result<Boolean> closePayment(@PathVariable("paymentId") Long paymentId) {
        ...
        if (result) {
            ...
            return Result.success("支付订单已关闭", true);
        } else {
