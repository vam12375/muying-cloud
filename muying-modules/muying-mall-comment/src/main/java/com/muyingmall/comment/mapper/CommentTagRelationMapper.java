package com.muyingmall.comment.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.muyingmall.comment.entity.CommentTag;
import com.muyingmall.comment.entity.CommentTagRelation;
...
public interface CommentTagRelationMapper extends BaseMapper<CommentTagRelation> {
         ...
         * @return 影响行数
         */
        @Delete("DELETE FROM comment_tag_relation WHERE comment_id = #{commentId}")
         ...
         * @return 影响行数
         */
        @Delete("DELETE FROM comment_tag_relation WHERE comment_id = #{commentId} AND tag_id = #{tagId}")
