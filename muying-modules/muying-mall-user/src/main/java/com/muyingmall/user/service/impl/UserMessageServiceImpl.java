...
import com.muyingmall.common.enums.MessageType;
...
public class UserMessageServiceImpl extends ServiceImpl<UserMessageMapper, UserMessage> implements UserMessageService {
    ...
    public IPage<UserMessage> getUserMessages(Integer userId, String type, Integer isRead, int page, int size) {
        ...
        // 缓存结果
        if (result != null && result.getRecords() != null && !result.getRecords().isEmpty() && redisUtil != null) {
    ...
    public Map<String, Integer> getUnreadCountByType(Integer userId) {
        ...
        if (redisUtil != null) {
            ...
            if (cacheResult != null) {
                ...
                Map<String, Integer> cachedMap = (Map<String, Integer>) cacheResult;
                return cachedMap;
            }
        }
