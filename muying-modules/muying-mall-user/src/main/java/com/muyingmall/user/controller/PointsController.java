...
// TODO: Use PointsServiceApi instead - import com.muyingmall.user.entity.PointsProduct;
import com.muyingmall.user.entity.PointsRule;
...
public class PointsController {
    ...
    public Result<Page<Object>> getPointsProducts(
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int pageSize,
            @RequestParam(required = false) String category) {
        Page<Object> productsPage = pointsService.getPointsProducts(page, pageSize, category);
    ...
    public Result<Object> getPointsProductDetail(@PathVariable("productId") Long productId) {
        Object product = pointsService.getPointsProductDetail(productId);
        if (product == null) {
    ...
    public Result<Map<String, Object>> signIn() {
        ...
        return Result.success("签到成功", signinResult);
    }
